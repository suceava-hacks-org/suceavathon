            ...
            <div>
              ...
              <div className="mt-8">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-white text-[#ec3750] hover:bg-yellow-100 px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition-all hover:shadow-lg"
                >
